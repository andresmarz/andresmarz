...
Here you’ll find a collection of projects that represent my learning journey in **.NET**, **Full-Stack projects**, **Clean Architecture and other architectures like MVC, Monolitic and Microservices**,**JWT**, **APIs REST**, **REST and RabbitMQ for Synchronous and Asynchronous messaging**, **Testing with XUnit and TDD**, **CI/CD**, **Azure**, **Python**, **AI** and beyond.  
